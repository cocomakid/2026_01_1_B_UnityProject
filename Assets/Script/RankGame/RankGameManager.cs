...
public class RankGameManager : MonoBehaviour
{
    ...
    public DraggableRank CreatRankInCell(GridCell cell, int level)
    {
        ...
        Vector3 rankPosition = new Vector3(cell.transform.position.x, cell.transform.position.y, 0f);       // 계급장 위치

        // 드래그 가능한 계급장 컨포넌트를 추가
    ...
    public bool SpawnNewRank()                                          // 새 계급장 생성
    {
        ...
        CreatRankInCell(emptyCell, rankLevel);                          // 3. 계급장 생성 및 설정
